/*Esse arquivo simulará o backend da nossa aplicação*/
export interface IProduto {
    id: number;
    descricao: string;
    preco: number;
    descricaoPreco: string;
    //Vamos acrescentar a "quantidade em estoque" para que, a quantidade exibida ao usuário, seja igual aquela existente no backend
    quantidadeEstoque: number;
    imagem: string;
}

/*Para criarmos uma interface que esteja de acordo com os itens, nós vamos criar essa interface para a gente. Nessa interface informaremos quais as informações que irão para dentro do carrinho. Nós vamos dizer que essa classe vai herar todas as propriedades da classe "IProduto" e nós vamos acrescentar umas propriedades próprias dela (que, nesse caso, será a quantidade que o usuário selecionou no momento da compra) */
export interface IProdutoCarrinho extends IProduto {
    quantidade: number;
}

/*Vamos acrescentar a propriedade "quantidadeEstoque" em todos os nossos objetos*/
